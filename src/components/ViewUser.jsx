...
export default function ViewUser() {
  ...
  useEffect(() => {
    axios
      .get('https://tacnique-backend.onrender.com/api/' + id)
      .then((res) => {
        setItem(res.data)
      })
  ...
  function handleFormSubmit(e) {
    ...
    axios
      ...
      .then((res) => {
        ...
        // setItem(
        //   item.map((item) => (item._id === selectedUser._id ? res.data : item))
        // )
        closeEditModal()
      })
      .catch((err) => console.log(err))
  ...
  return (
    <div>
      <Tilt
        ...
        className="hover:bg-gray-100 transition duration-75 ease-in-out group w-[400px] my-[60px] mx-auto">
        <div className="shadow-lg px-[20px] py-[30px] ">
          <div className="flex place-content-center py-[10px] gap-[10px]">
            ...
            <h1 className="text-[30px] font-medium group-hover:text-gray-600">
          ...
          <div className="flex place-content-center gap-[10px] py-[10px]">
            ...
            <h1 className="text-[18px] font-medium group-hover:text-gray-600">
              {item.email}
            </h1>
          </div>
          <div className="flex place-content-center gap-[10px] py-[10px]">
